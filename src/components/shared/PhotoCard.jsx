  ...
  return (
    <>
      <section className=" rounded-t-lg flex flex-col md:flex-row lg:flex-col">
        <div className="img md:max-w-[50%] lg:max-w-full">
          <img
        ...
        <div className="info md:flex bg-[#FDF3F0] hover:bg-peach  rounded-b-lg md:rounded-bl-none md:rounded-br-2xl md:rounded-r-2xl lg:rounded-bl-2xl py-15 px-8 group lg:rounded-tr-none transition-all duration-300">
